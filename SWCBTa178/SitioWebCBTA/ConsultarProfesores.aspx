<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarProfesores.aspx.cs" Inherits="SitioWebCBTA.ConsultarProfesores" %>
                ...
                <div class="tab-pane active" id="tab1">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Lista de Profesores</h3>
                        ...
                        <div class="panel-body">
                                <form id="Form1" class="form-horizontal" runat="server">
                                    ...
                                    <div class="col-xs-9">
                                        <asp:GridView ID="GridViewProfesores" EmptyDataText="No hay materias para mostrar..." runat="server" AutoGenerateColumns="False"  CssClass="table" DataSourceID="SqlDataSource1"  >
                                            <Columns>
                                                <asp:BoundField DataField="IdProfesor" HeaderText="Clave" SortExpression="IdProfesor" />
                                                <asp:BoundField DataField="UsuarioProfesor" HeaderText="UsuarioProfesor" SortExpression="UsuarioProfesor" />
                                                <asp:BoundField DataField="ContrasenniaProfesor" HeaderText="ContrasenniaProfesor" SortExpression="ContrasenniaProfesor" />
                                                <asp:BoundField DataField="NombreProfesor" HeaderText="NombreProfesor" SortExpression="NombreProfesor" />
                                                <asp:BoundField DataField="ApellidosProfesor" HeaderText="ApellidosProfesor" SortExpression="ApellidosProfesor" />
                                            </Columns>
                                           
                                        </asp:GridView>
                                    
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand="SELECT [IdProfesor],[UsuarioProfesor], [ContrasenniaProfesor], [NombreProfesor], [ApellidosProfesor] FROM [Profesores]"></asp:SqlDataSource>
