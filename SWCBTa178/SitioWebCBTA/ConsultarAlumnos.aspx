<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarAlumnos.aspx.cs" Inherits="SitioWebCBTA.ConsultarAlumnos" %>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                                <form id="Form1" class="form-horizontal" runat="server">
                                    ...
                                    <div class="col-xs-9">
                                        <asp:GridView ID="GridViewAlumnos" EmptyDataText="No hay alumnos para mostrar..." runat="server" AutoGenerateColumns="False"  CssClass="table" DataSourceID="SqlDataSource1"  >
                                            <Columns>
                                                <asp:BoundField DataField="MatriculaAlumno" HeaderText="MatriculaAlumno" SortExpression="MatriculaAlumno" />
                                                <asp:BoundField DataField="NombreAlumno" HeaderText="NombreAlumno" SortExpression="NombreAlumno" />
                                                <asp:BoundField DataField="ApellidosAlumno" HeaderText="ApellidosAlumno" SortExpression="ApellidosAlumno" />
                                                <asp:BoundField DataField="EdadAlumno" HeaderText="EdadAlumno" SortExpression="EdadAlumno" />
                                                <asp:BoundField DataField="EmailAlumno" HeaderText="EmailAlumno" SortExpression="EmailAlumno" />
                                            </Columns>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand="SELECT [MatriculaAlumno], [NombreAlumno], [ApellidosAlumno], [EdadAlumno], [EmailAlumno] FROM [Alumnos]"></asp:SqlDataSource>
